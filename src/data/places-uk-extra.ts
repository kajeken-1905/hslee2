...
export const placesUKExtra: Place[] = [
  ...
  place('edinburgh-starbucks-1', 'edinburgh', 'starbucks', 'Starbucks (Princes Street)', 4.0, 'Princes Street, Edinburgh', '프린시스 스트리트 관광 동선.', 'On the Princes Street tourist route.', { reviewCount: 1900 }),
  place('edinburgh-starbucks-2', 'edinburgh', 'starbucks', 'Starbucks (Royal Mile area)', 3.9, 'High Street, Edinburgh', '로열 마일 인근.', 'Near the Royal Mile.', { reviewCount: 1200 }),
  place('edinburgh-starbucks-3', 'edinburgh', 'starbucks', 'Starbucks (Waverley)', 3.9, 'Waverley Station area', '웨이벌리역 환승용.', 'Handy for Waverley transfers.', { reviewCount: 1400 }),
  place('edinburgh-starbucks-4', 'edinburgh', 'starbucks', 'Starbucks (Edinburgh Airport area)', 3.8, 'Edinburgh', '공항·외곽 편의 지점.', 'Airport/outskirts convenience stop.', { reviewCount: 800 }),
  ...
  place('manchester-starbucks-1', 'manchester', 'starbucks', 'Starbucks (Market Street)', 4.0, 'Market Street, Manchester', '쇼핑 거리 지점.', 'Shopping street location.', { reviewCount: 1800 }),
  place('manchester-starbucks-2', 'manchester', 'starbucks', 'Starbucks (Piccadilly)', 3.9, 'Piccadilly, Manchester', '피카딜리역 인근.', 'Near Piccadilly station.', { reviewCount: 1600 }),
  place('manchester-starbucks-3', 'manchester', 'starbucks', 'Starbucks (Deansgate)', 3.9, 'Deansgate, Manchester', '딘스게이트 권역.', 'Deansgate area.', { reviewCount: 1100 }),
  place('manchester-starbucks-4', 'manchester', 'starbucks', 'Starbucks (Spinningfields)', 3.8, 'Spinningfields', '비즈니스 지구.', 'Business district stop.', { reviewCount: 780 }),
  ...
  place('bath-starbucks-1', 'bath', 'starbucks', 'Starbucks (Stall Street)', 4.0, 'Bath', '관광 중심가.', 'Tourist centre.', { reviewCount: 1500 }),
  place('bath-starbucks-2', 'bath', 'starbucks', 'Starbucks (SouthGate)', 3.9, 'SouthGate, Bath', '쇼핑몰 권역.', 'Mall area.', { reviewCount: 980 }),
  ...
  place('oxford-starbucks-1', 'oxford', 'starbucks', 'Starbucks (Cornmarket)', 4.0, 'Cornmarket Street', '쇼핑 거리.', 'Shopping street.', { reviewCount: 1700 }),
  place('oxford-starbucks-2', 'oxford', 'starbucks', 'Starbucks (Queen Street)', 3.9, 'Queen Street', '센터 지점.', 'Centre location.', { reviewCount: 1200 }),
  ...
  place('cambridge-starbucks-1', 'cambridge', 'starbucks', 'Starbucks (Sidney Street)', 4.0, 'Sidney Street', '센터 지점.', 'Centre location.', { reviewCount: 1500 }),
  place('cambridge-starbucks-2', 'cambridge', 'starbucks', 'Starbucks (Market area)', 3.9, 'Market Street', '시장 인근.', 'Near the market.', { reviewCount: 1100 }),
  ...
  place('liverpool-starbucks-1', 'liverpool', 'starbucks', 'Starbucks (Liverpool ONE)', 4.0, 'Liverpool ONE', '쇼핑몰 지점.', 'Shopping centre.', { reviewCount: 1700 }),
  place('liverpool-starbucks-2', 'liverpool', 'starbucks', 'Starbucks (Lime Street)', 3.9, 'Lime Street', '역 인근.', 'Near the station.', { reviewCount: 1300 }),
  place('liverpool-starbucks-3', 'liverpool', 'starbucks', 'Starbucks (Albert Dock)', 3.9, 'Albert Dock', '도크 관광 동선.', 'Albert Dock tourist route.', { reviewCount: 1100 }),
  ...
  place('brighton-starbucks-1', 'brighton', 'starbucks', 'Starbucks (Brighton Station)', 4.0, 'Brighton Station', '역 지점.', 'Station location.', { reviewCount: 1500 }),
  place('brighton-starbucks-2', 'brighton', 'starbucks', 'Starbucks (Western Road)', 3.9, 'Western Road', '쇼핑 거리.', 'Shopping street.', { reviewCount: 1100 }),
  place('brighton-starbucks-3', 'brighton', 'starbucks', 'Starbucks (Marina)', 3.8, 'Brighton Marina', '마리나 권역.', 'Marina area.', { reviewCount: 760 }),
  ...
  place('york-starbucks-1', 'york', 'starbucks', 'Starbucks (Parliament Street)', 4.0, 'Parliament Street', '센터.', 'Centre.', { reviewCount: 1400 }),
  place('york-starbucks-2', 'york', 'starbucks', 'Starbucks (Coppergate)', 3.9, 'Coppergate', '쇼핑 권역.', 'Shopping area.', { reviewCount: 980 }),
  ...
  place('bristol-starbucks-1', 'bristol', 'starbucks', 'Starbucks (Cabot Circus)', 4.0, 'Cabot Circus', '쇼핑몰.', 'Shopping centre.', { reviewCount: 1500 }),
  place('bristol-starbucks-2', 'bristol', 'starbucks', 'Starbucks (Broadmead)', 3.9, 'Broadmead', '쇼핑 거리.', 'Shopping street.', { reviewCount: 1100 }),
  place('bristol-starbucks-3', 'bristol', 'starbucks', 'Starbucks (Temple Meads area)', 3.9, 'Temple Meads', '역 인근.', 'Near the station.', { reviewCount: 980 }),
